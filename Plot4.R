...
par(mfrow=c(2,2))
plot(fdata1$CompleteTime,as.numeric(fdata1$Global_active_power),type="l",ylab="Global Active Power(kilowatts)",xlab="")
plot(fdata1$CompleteTime,as.numeric(fdata1$Voltage),type="l",ylab="Voltage",xlab="datetime")
...
legend("topright",col = c("black","red","blue"),c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,cex=0.5,bty="n")
plot(fdata1$CompleteTime,as.numeric(fdata1$Global_reactive_power),type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()